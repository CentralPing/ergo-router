 ...
 * @param {function} [options.onResponse] - Router-level post-send observation hook.
 *   Fires on every route after send(). Route-level hooks fire first. Receives
 *   `(req, res, responseInfo, domainAcc)`. Hook errors are swallowed.
