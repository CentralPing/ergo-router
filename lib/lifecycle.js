 ...
 * @param {{info: (...args: any[]) => void, warn: (...args: any[]) => void, error: (...args: any[]) => void}} [options.log=console] - Logger with `.info()`, `.warn()`, `.error()` methods
 ...
 * @param {(code?: number) => void} [options.exit=process.exit] - Exit function (override for testing)
 * @param {(ctx: {log: {info: (...args: any[]) => void, warn: (...args: any[]) => void, error: (...args: any[]) => void}}) => void | Promise<void>} [options.onStartup] - Hook called before `server.listen()`.
 *   Receives `{log}`. Rejection prevents the server from starting.
 * @param {(ctx: {log: {info: (...args: any[]) => void, warn: (...args: any[]) => void, error: (...args: any[]) => void}, signal: string}) => void | Promise<void>} [options.onShutdown] - Hook called after `server.close()`.
