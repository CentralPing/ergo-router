 ...
 * @param {object|false} [routeConfig.authorization] - Authorization options or `false`
 ...
 * @param {object|boolean|false} [routeConfig.idempotency] - Idempotency-Key options, `true` for defaults, or `false`
 ...
 * @param {function} routeConfig.execute - Route handler `(req, res, domainAcc, responseAcc) => {value?, response?}`
