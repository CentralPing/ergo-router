 ...
 * @type {Set<string>}
 */
export const ROUTE_OPTION_KEYS = new Set(['send', 'noSend', 'catchHandler', 'onResponse']);
 ...
 *
 * Checks `send` (object), `noSend` (boolean), `catchHandler` (function), and
 * `onResponse` (function) when present. Does NOT validate keys — callers are
